export WANDB_API_KEY="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"
...
accelerate launch --num_processes 8 --config_file /data/ckpt_zsqiao/codes/LTX-2/packages/ltx-trainer/configs/accelerate/ddp.yaml \
  ...
  /data/ckpt_zsqiao/codes/LTX-2/packages/ltx-trainer/configs/ltx2_keyframe_lora.yaml